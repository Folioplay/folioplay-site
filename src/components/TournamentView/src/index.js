...
import {deleteTeam, getAllUserTeams, getTournamentById, joinTournamentAPI} from "../../../APIS/apis";
                                ...
                                />
                                      ...
                                      <div className="mt-10" id="create-new-button-div">
                                          ...
                                          <Snackbar open={snackOpen} autoHideDuration={3500} onClose={handleSnackClose}>
                                              <motion.div id="snack-bar-div" initial={{y: 200}} animate={{y: 0}}
                                                          transition={{duration: 0.3}}>
                                                  <Alert id="team-creation-message" onClose={handleSnackClose}
