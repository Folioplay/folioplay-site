            ...
            <div className="fullpage">
                ...
                <div className="wallet-add-space">
                    <span className="wallet-info font-size-25 font-weight-800">
                        <AccountBalanceWalletIcon fontSize="large" style={{ color: "var(--white)" }} />
                        <span className="wallet-address ml-20">{walletAdd.substring(0, 6) + "...." + walletAdd.substring(walletAdd.length - 4)}</span>
                        <ContentCopyIcon id="copy-to-clipboard" className="ml-20" fontSize="medium" style={{ color: "var(--white)" }} onClick={copytoClipboard} />
                    </span>
                </div>
