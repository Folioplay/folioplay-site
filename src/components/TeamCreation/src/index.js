...
import LeftTeamCreation from "./LeftTeamCreation";
import RightTeamCreation from "./RightTeamCreation";
export function TeamCreation() {
  ...
  return (
    <FolioPlayLayout
      LeftComponent={LeftTeamCreation}
      RightComponent={RightTeamCreation}
    />
  );
}
