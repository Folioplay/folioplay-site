...
// import coinRound from "../../../images/coinRound.gif"
// import { useDispatch, useSelector } from "react-redux";
// import CoinSelectionSlice, {
//   getCoinSelectionAsync,getSelectedCoinSlice
// } from "../../../Redux/CoinSelectionS/CoinSelectionSlice";
...
//   const [selectedCoinCount, setSelectedCoinCount] =useState(localStorage.getItem("SelectedCoinCount"));
...
//   async function checkSelectedCoins(){
//     const localSelected =  localStorage.getItem("SelectedCoinCount");
//      setSelectedCoinCount(localSelected);
//     console.log(selectedCoinCount)
//   }
...
// const localSelected = await localStorage.getItem("SelectedCoinCount");
//     await setSelectedCoinCount(localSelected);
//     console.log(selectedCoinCount)
//   }
  
//   const coinSelection = useSelector(state => state.get_coin_Selection?.coinSelection);
//   console.log("line no 97");
//   console.log(coinSelection  );
//   console.log("line no 97");
//   useEffect(() => {
//     dispatch(getCoinSelectionAsync);
...
// const county = 11;
// const selected = 6;
//   const rA = Array.from({ length: county }).map((_, index) => (
//     <div key={index}>
...
//  console.log("coins redux 780 line");
...
//   // const [wasActiveTab, setWasActiveTab] = useState(localStorage.getItem("wasActiveTabeState") || "mooning");
//   const coinsRedux = useSelector((state) => state.coinsSlice.coins);
//   // const selectedItems =useSelector((state) => state.coinsSlice.selectedItem);
...
// useEffect(()=>{
// console.log("line 931 useEffect");
// },[selectedItemscoins])
...
//     // );
//     // localStorage.setItem("SuperStarSelected", JSON.stringify(changeSelect));
//     dispatch(toggleSelectedCoins(coinn));
//     // setSuperstarfilter(changeSelect);
//   } else if(coinSelected){
//     // const changeSelect = superstarfilter.map(coin =>
//     //   coin.id === e ? { ...coin, selected: !coin.selected } : coin
...
//   const selected = 6;
//   const cons = rektSelectedCoins+ superstartSelectedCoins+mooningSelectedCoins;
//   const all = [...mooningfilter,...rektfilter]
//     const CoinsCounterCircle = Array.from({ length: county }).map((_, index) => (
//       <div key={index}>
//         {/* <img src={coinRound} alt="Image" style={{ width: "50px" }} /> */}
//           {index+1 <= cons && cons !==undefined &&  cons >0 ? ( <div style={{width:"20px",height:"20px",backgroundColor:"#fea31b",borderRadius:"50%",color:"#fea31b",border:"2px solid #fea31b",textAlign:"center",fontSize:"0.9rem",alignItems:"center",fontWeight:"bold"}}>{`${index+1}`}</div>
...
//     //   >
//     //     {superstarfilter.map((coin, index) => (
//     //       <Grid className="coin-card-wrapper" item xs={6} key={index}>
//     //         <motion.div
//     //           initial={{ opacity: 0 }}
//     //           animate={{ opacity: 1 }}
//     //           transition={{ duration: 0.07 * index }}
...
//           {/* <h3>Doesn't these big winnings look WOW? Ofcourse they do!</h3> */}
//         </div>
//         <TeamPreview  mooningfilter={mooningfilter} rektfilter={rektfilter} />
