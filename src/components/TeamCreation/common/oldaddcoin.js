...
const SuperStarSelectedCoinCount = superstars.filter((coin) => coin.selected === true);
const sup = SuperStarSelectedCoinCount.length;
const RektSelectedCoinCount = rekt.filter((coin) => coin.selected === true);
const rek = RektSelectedCoinCount.length;
const MooningSelectedCoinCount = mooning.filter((coin) => coin.selected === true);
const mon = MooningSelectedCoinCount.length;

localStorage.setItem("SuperStarSelectedCoinCount", sup);
localStorage.setItem("MooningSelectedCoinCount", mon);
localStorage.setItem("RektSelectedCoinCount", rek);
