...
export default function TeamPreview({ superstars, mooning, rekt }) {
    ...
    mooning = [{ name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }]
    rekt = [{ name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }, { name: "default" }]
    return (
