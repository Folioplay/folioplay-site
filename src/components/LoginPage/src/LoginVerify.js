  ...
  const finishSocialLogin = async () => {
    ...
    if (Loggedinn) {
      ...
      try {
        ...
        const userdata = await getMagicAuthToken(didToken, walletAddress);
            ...
            <div className="loginverfiyPageBlink">
              <div className="blinkData">
                ...
                <div>
                  {" "}
                  <img
                    src={folioPlayLogoText}
                    alt="folioplayLogo"
                    className="loginVerifyFPText"
                    style={{ zIndex: "1" }}
                  />
                </div>
              </div>
